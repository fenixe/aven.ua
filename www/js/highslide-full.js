...
lang : {
	cssDirection: 'ltr',
	lloadingText : 'Загрузка...',
	loadingTitle : 'Нажмите чтобы закрыть',
	focusTitle : 'Нажмите, чтобы показать на переднем плане',
	fullExpandTitle : 'Развернуть до фактического размера (f)',
	previousText : 'Предедущая',
	nextText : 'Следующая', 
	moveText : 'Двигать',
	closeText : 'Закрыть', 
	closeTitle : 'Закрыть (esc)', 
	resizeTitle : 'Изменить размер',
	playText : 'Проигрывать',
	...
	restoreTitle : 'Щелкните, чтобы закрыть изображение, нажмите и перетащите для перемещения. Используйте клавиши со стрелками для следующего и предыдущего изображения.'
},
